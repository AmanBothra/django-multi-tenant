...
// checkbox select-all end js //


//toggle-menu hide/show start js //

var myElement = document.querySelector('.section-main');
document.querySelector('.navbar-toggler').onclick = function () {

  myElement.classList.toggle('sidebar-icon-only');
};
//toggle-menu hide/show end js //

// Multiple selector js start here //
...
// multiple selector js end here //

// full-screen toggle js start here //
...
// full-screen toggle js end here //
